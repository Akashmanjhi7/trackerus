...
const Navbar = () => {
  return (
    <nav className='    w-full'>
      <div className=" flex flex-wrap items-center justify-between mx-auto p-4 fixed top-0 left-0 right-0 z-50 bg-zinc-100  ">
        <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          {/* <img src="https://flowbite.com/docs/images/logo.svg" className="h-8" alt="Flowbite Logo" /> */}
          <span className="self-center text-2xl font-semibold whitespace-nowrap">TRACKER US</span>
        </Link>
